...
pData <- read.csv("/users/bcarancibia/CUNY_IS608/lecture2/data/all_PLUTO_data.csv", header = TRUE, sep =",", na.strings=(""), stringsAsFactors=FALSE)
as.data.frame(pData)
#super hackish and not proud could not figure out why import was in factors and not numeric
